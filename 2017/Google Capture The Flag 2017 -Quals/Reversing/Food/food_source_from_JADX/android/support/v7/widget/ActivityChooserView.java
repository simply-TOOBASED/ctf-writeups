...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModelClient {
    ...
    class C01491 extends DataSetObserver {
        C01491() {
        }
    ...
    class C01502 implements OnGlobalLayoutListener {
        C01502() {
        }
    ...
    class C01514 extends DataSetObserver {
        C01514() {
        }
    ...
    public ActivityChooserView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mModelDataSetOberver = new C01491();
        this.mOnGlobalLayoutListener = new C01502();
        ...
        this.mAdapter.registerDataSetObserver(new C01514());
