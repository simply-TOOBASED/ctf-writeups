...
class AppCompatDelegateImplV7 extends AppCompatDelegateImplBase implements Callback, LayoutInflaterFactory {
    ...
    class C01365 implements Runnable {
        ...
        class C02161 extends ViewPropertyAnimatorListenerAdapter {
            C02161() {
            }
        ...
        public void run() {
            ...
            AppCompatDelegateImplV7.this.mFadeAnim.setListener(new C02161());
        }
    }
    ...
    private static final class PanelFeatureState {
        ...
        private static class SavedState implements Parcelable {
            public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C02061());
            int featureId;
            boolean isOpen;
            Bundle menuState;
    ...
    class ActionModeCallbackWrapperV7 implements ActionMode.Callback {
        ...
        class C02181 extends ViewPropertyAnimatorListenerAdapter {
            C02181() {
            }
        ...
        public void onDestroyActionMode(ActionMode mode) {
            ...
            if (AppCompatDelegateImplV7.this.mActionModeView != null) {
                ...
                AppCompatDelegateImplV7.this.mFadeAnim.setListener(new C02181());
            }
    ...
    class C02176 extends ViewPropertyAnimatorListenerAdapter {
        C02176() {
        }
    ...
    private ViewGroup createSubDecor() {
        ...
        if (a.hasValue(C0140R.styleable.Theme_windowActionBar)) {
            ...
            abcContent.setAttachListener(new C02054());
            return subDecor;
        }
        a.recycle();
        ...
        if (mode != null) {
            ...
            if (this.mActionModeView != null) {
                ...
                if (callback.onCreateActionMode(mode, mode.getMenu())) {
                    ...
                    this.mFadeAnim.setListener(new C02176());
                    if (this.mActionModePopup != null) {
