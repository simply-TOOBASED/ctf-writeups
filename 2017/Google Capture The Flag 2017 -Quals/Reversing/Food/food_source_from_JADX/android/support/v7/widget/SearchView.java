...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    class C01624 implements OnFocusChangeListener {
        C01624() {
        }
    ...
    class C01635 implements OnLayoutChangeListener {
        C01635() {
        }
    ...
    class C01646 implements OnGlobalLayoutListener {
        C01646() {
        }
    ...
    class C01657 implements OnClickListener {
        C01657() {
        }
    ...
    class C01668 implements OnKeyListener {
        C01668() {
        }
    ...
    class C01679 implements OnEditorActionListener {
        C01679() {
        }
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mShowImeRunnable = new C01591();
        this.mUpdateDrawableStateRunnable = new C01602();
        this.mReleaseCursorRunnable = new C01613();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C01657();
        this.mTextKeyListener = new C01668();
        this.mOnEditorActionListener = new C01679();
        ...
        this.mSearchSrcTextView.setOnFocusChangeListener(new C01624());
    ...
    private void addOnLayoutChangeListenerToDropDownAnchorSDK11() {
        this.mDropDownAnchor.addOnLayoutChangeListener(new C01635());
    }

    private void addOnLayoutChangeListenerToDropDownAnchorBase() {
        this.mDropDownAnchor.getViewTreeObserver().addOnGlobalLayoutListener(new C01646());
    }
