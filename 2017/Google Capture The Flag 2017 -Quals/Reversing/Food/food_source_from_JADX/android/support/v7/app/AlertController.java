...
class AlertController {
    ...
    private void setupView() {
        View parentPanel = this.mWindow.findViewById(C0140R.id.parentPanel);
        View defaultTopPanel = parentPanel.findViewById(C0140R.id.topPanel);
        View defaultContentPanel = parentPanel.findViewById(C0140R.id.contentPanel);
        View defaultButtonPanel = parentPanel.findViewById(C0140R.id.buttonPanel);
        ViewGroup customPanel = (ViewGroup) parentPanel.findViewById(C0140R.id.customPanel);
        setupCustomContent(customPanel);
        View customTopPanel = customPanel.findViewById(C0140R.id.topPanel);
        View customContentPanel = customPanel.findViewById(C0140R.id.contentPanel);
        View customButtonPanel = customPanel.findViewById(C0140R.id.buttonPanel);
        ...
        if (!(hasButtonPanel || contentPanel == null)) {
            View spacer = contentPanel.findViewById(C0140R.id.textSpacerNoButtons);
            if (spacer != null) {
    ...
    private void setScrollIndicators(ViewGroup contentPanel, View content, int indicators, int mask) {
        View indicatorUp = this.mWindow.findViewById(C0140R.id.scrollIndicatorUp);
        View indicatorDown = this.mWindow.findViewById(C0140R.id.scrollIndicatorDown);
    ...
    private void setupContent(ViewGroup contentPanel) {
        this.mScrollView = (NestedScrollView) this.mWindow.findViewById(C0140R.id.scrollView);
